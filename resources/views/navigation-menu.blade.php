            ...
            <div class="flex">
                ...
                <div class="flex-shrink-0 flex items-center">
                    <a href="{{ route('dashboard') }}">
                        <img src="{{ URL::to('/assets/images/logo.png') }}" width="64" height="64">
                    </a>
                </div>

                <!-- Navigation Links -->
                <!-- anasayfa header dashboard yazisi -->
                ...
                <!--anasayfa header profile yazisi
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-jet-nav-link href="{{ route('quizzes.index') }}" :active="request()->routeIs('dashboard')">
                        {{ __('Quizler') }} <!--anasayfa quizler yazisi -->
                    </x-jet-nav-link>
                </div>
                    <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                        <x-jet-nav-link href="{{ route('users.index') }}" :active="request()->routeIs('dashboard')">
                        {{ __('Kullanicilar') }} <!--anasayfa kullanicilar yazisi -->
                        </x-jet-nav-link>
                    </div>
                @endif
            </div>
