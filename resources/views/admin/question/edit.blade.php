<x-app-layout>
    <x-slot name="header"> Edit Question for {{$question->question}} </x-slot>
    <div class="card">
        <div class="card-body">
            <form method="POST" action="{{route('questions.update',[$question->quiz_id,$question->id])}}" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    <button type="submit" class="btn btn-success btn-sm btn-block" style="width: 100%"> Update Question</button>
                </div>
            </form>
        </div>
    </div>
